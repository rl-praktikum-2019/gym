...
class MultiHandEnv(robot_env.RobotEnv):
    def __init__(self, model_path, n_substeps, initial_qpos, relative_control):
        self.relative_control = relative_control

        super(MultiHandEnv, self).__init__(
            model_path=model_path, n_substeps=n_substeps, n_actions=40,
    ...
    def render(self, mode='human', width=500, height=500):
        return super(MultiHandEnv, self).render(mode, width, height)
